...
class config:
    ...
    def __init__(self):
        ...
        self.deplibs = ['saturne',                      # Code_Saturne
                        ...
                        'mui',                          # User & system libraries
                        'muicoupling']                       # User & system libraries
        ...
        self.flags = {'cflags': "-std=c99 -fms-extensions -funsigned-char -pedantic -W -Wall -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -Wmissing-declarations -Wnested-externs -Wunused -Wfloat-equal -Wmisleading-indentation -Wduplicated-cond -fdiagnostics-color=auto -O3 -fopenmp -g ",
                      'cxxflags': "-W -Wall -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Wunused -Wfloat-equal -std=c++11 -Wmisleading-indentation -Wduplicated-cond -fdiagnostics-color=auto -O3 -g ",
                      'fcflags': "-x f95-cpp-input -Wall -pedantic-errors -std=f2003 -fdiagnostics-color=auto -O3 -fopenmp -g -fcheck=bounds "}

        self.fcmodinclude = "-I"
        self.rpath = "-Wl,-rpath -Wl,/opt/gcc/10.1.0/snos/lib/gcc/x86_64-suse-linux/10.1.0/../../../../lib64/opt/gcc/10.1.0/snos/lib/gcc/x86_64-suse-linux/10.1.0/../../../../lib64"
        ...
        self.python = "/opt/cray/pe/python/3.8.5.0/bin/python"
        self.pyuic4 = ""
        self.pyrcc4 = ""
        self.pyuic5 = ""
        self.pyrcc5 = ""
        ...
        self.env_modules = "no"
        self.env_modulecmd = "/usr/local/Modules/bin/modulecmd"
        ...
        self.libs['mui'] = \
            prerequisite("MUI",
                         have = "yes",
                         flags = {'cppflags': "-I/work/c01/c01/wendiliu/app/MUI/MUI-1.1 -DHAVE_MUI",
                                  'ldflags': "-L/work/c01/c01/wendiliu/app/MUI/MUI-1.1/wrappers/C",
        ...
        self.libs['muicoupling'] = \
            prerequisite("muicoupling",
                         have = "yes",
                         flags = {'cppflags': "-I/work/c01/c01/wendiliu/app/MUI/MUI-1.1/couplingFSILab/wrappers/C -I/work/c01/c01/wendiliu/app/MUI/MUI-1.1/couplingFSILab -I/work/c01/c01/wendiliu/app/MUI/MUI-1.1 -DHAVE_MUI",
                                  'ldflags': "-L/work/c01/c01/wendiliu/app/MUI/MUI-1.1/couplingFSILab/wrappers/C -L/work/c01/c01/wendiliu/app/MUI/MUI-1.1/couplingFSILab -L/work/c01/c01/wendiliu/app/MUI/MUI-1.1/wrappers/C",
        ...
        self.libs['system'] = \
            prerequisite("System",
                         have = "yes",
                         flags = {'cppflags': "  -D_POSIX_C_SOURCE=200809L -DDEBUG ",
                                  'ldflags': "  -g -Wl,-export-dynamic -fopenmp ",
                                  'libs': " -lz   -ldl  -L/opt/cray/pe/libsci/20.10.1.2/GNU/9.1/x86_64/lib -L/opt/cray/pe/dsmml/0.1.2/dsmml//lib -L/opt/cray/pe/mpich/8.0.16/ofi/gnu/9.1/lib -L/opt/cray/xpmem/2.2.35-7.0.1.0_1.9__gd50fabf.shasta/lib64 -L/opt/gcc/10.1.0/snos/lib/gcc/x86_64-suse-linux/10.1.0 -L/opt/gcc/10.1.0/snos/lib/gcc/x86_64-suse-linux/10.1.0/../../../../lib64 -L/lib/../lib64 -L/usr/lib/../lib64 -L/opt/gcc/10.1.0/snos/lib/gcc/x86_64-suse-linux/10.1.0/../../.. -lsci_gnu_82_mpi -lsci_gnu_82 -ldl -lxpmem -ldsmml -lmpi_gnu_91 -lmpifort_gnu_91 -lgfortran -lquadmath -lpthread -lm"})
        ...
        self.libs['hdf5'] = \
            prerequisite("HDF5",
                         have = "no",
                         flags = {'cppflags': "  -DMPICH_SKIP_MPICXX",
                                  'ldflags': "",
                                  'libs': ""})
        ...
        self.libs['scotch'] = \
            prerequisite("SCOTCH",
                         have = "yes",
                         flags = {'cppflags': "-I/work/c01/c01/wendiliu/app/FEniCS/V2019.1.0/boost/scotch_6.0.10/include",
                                  'ldflags': "-L/work/c01/c01/wendiliu/app/FEniCS/V2019.1.0/boost/scotch_6.0.10/lib",
                                  'libs': "-lptscotch -lscotch -lm"})
